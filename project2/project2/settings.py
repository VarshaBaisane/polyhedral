...
SECRET_KEY = 'django-insecure-0hbiw12i)39$wwm@ait(!1s$eoe&n180-6=xsb@+@fv@jgxz#d'
...
# Channels Layer using Redis (Ensure Redis is installed and running)
#CHANNEL_LAYERS = {
 #   'default': {
...
LOGIN_URL = '/login/'  # Matches the login view path in your URLs
